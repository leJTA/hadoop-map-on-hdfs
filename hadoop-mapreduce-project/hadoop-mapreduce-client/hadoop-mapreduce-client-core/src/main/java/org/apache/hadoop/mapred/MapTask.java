 ...
 private <T> T getSplitDetails(Path file, long offset)
  ...
  public static class MapOutputBuffer<K extends Object, V extends Object>
    ...
    public void init(MapOutputCollector.Context context
      ...
      defaultFS = FileSystem.get(context.getJobConf()); // JTA
    ...
    public void flush() throws IOException, ClassNotFoundException,
      ...
      fileOutputByteCounter.increment(defaultFS.getFileStatus(outputPath).getLen()); // JTA
      ...
      if (!SHUFFLE_OUTPUT_PERM.equals(
        ...
        defaultFS.setPermission(outputPath, SHUFFLE_OUTPUT_PERM); // JTA
        defaultFS.setPermission(indexPath, SHUFFLE_OUTPUT_PERM); // JTA
      }
    }
    ...
    private void mergeParts() throws IOException, InterruptedException,
      ...
      FSDataOutputStream finalOut = defaultFS.create(finalOutputFile, true, 4096); // JTA
